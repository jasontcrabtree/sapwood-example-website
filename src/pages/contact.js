  ...
  query contactPageQuery {
    prismicContactPage {
      ...
      data {
        body {
          __typename
          ... on PrismicContactPageBodyPageTitleBlock {
            id
            slice_type
            primary {
              main_page_title
          ...
          ... on PrismicContactPageBodyContentBlock {
            id
            slice_type
            primary {
              section_title {
          ...
          ... on PrismicContactPageBodyCardGridBlock {
            id
            slice_type
            primary {
              title_style
          ...
          ... on PrismicContactPageBodyColumnTextBlock {
            id
            slice_type
            primary {
          ...
          ... on PrismicContactPageBodyCustomBlock {
            id
            slice_type
            primary {
          ...
          ... on PrismicContactPageBodyImageBlock {
            id
            slice_type
            primary {
              image {
