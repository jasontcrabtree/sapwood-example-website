  ...
  query pricingPageQuery {
    prismicPricingPage {
      ...
      data {
        body {
          __typename
          ... on PrismicPricingPageBodyPageTitleBlock {
            id
            slice_type
            primary {
              main_page_title
          ...
          ... on PrismicPricingPageBodyContentBlock {
            id
            slice_type
            primary {
              section_title {
          ...
          ... on PrismicPricingPageBodyCardGridBlock {
            id
            slice_type
            primary {
              title_style
          ...
          ... on PrismicPricingPageBodyColumnTextBlock {
            id
            slice_type
            primary {
          ...
          ... on PrismicPricingPageBodyCustomBlock {
            id
            slice_type
            primary {
          ...
          ... on PrismicPricingPageBodyImageBlock1 {
            id
            slice_type
            primary {
              image {
...
const index = (props) => {
  ...
  const sliceZoneBody = props.data.prismicPricingPage.data.body;
